...
describe("calculateRackScore", () => {
    ...
    it("should correctly calculate the score for a valid word", () => {
        ...
        const score = calculateRackScore(rack, multiplier, true)

        expect(score.baseScore).toBe(5)
        expect(score.multiplier).toBe(multiplier)
    })
    ...
    it("should return a base score of 0 for an invalid word", () => {
        ...
        const score = calculateRackScore(rack, multiplier, false)

        expect(score.baseScore).toBe(0)
        expect(score.multiplier).toBe(multiplier) // Multiplier is still calculated based on length
    })
