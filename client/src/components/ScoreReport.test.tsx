...
describe("ScoreReport", () => {
	...
	const mockSummary: ScoreSummary = { totalScore: 60, targetScore: 48, scoreDifference: 12, isOverTarget: true }
	...
	it("should render a detailed, accessible summary for screen readers", () => {
		const targetWords = mockTargetSolution.map((rack) => rack.map((tile) => tile.letter).join(""))
